...
jk::ConnectionHandler::ConnectionHandler(int _socket, int _spooler) :
	socket(_socket),
	spooler(_spooler),
	conClosed(false),
	readBuffer(),
...
ConnectionHandler& jk::ConnectionHandler::operator=(const ConnectionHandler& other)
{
	socket        = other.socket;
	spooler       = other.spooler;
	conClosed     = other.conClosed;
...
bool jk::ConnectionHandler::write_pending()
{
	return writePending;
}

bool jk::ConnectionHandler::connection_closed()
{
	return conClosed;
}
